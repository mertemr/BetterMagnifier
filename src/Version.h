...
#define BM_VERSION_MINOR 1 // x-release-please-minor
#define BM_VERSION_PATCH 1 // x-release-please-patch

#define BM_VERSION_STRING "0.1.1" // x-release-please-version
